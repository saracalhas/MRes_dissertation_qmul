...
# ### This notebook contains experiment 1 to 11 of the XGBoost experiments. These round does not include age and apoe4 alleles. This code was run via bash.
...
columnns_to_drop_2 = ['eid', 'APOE4', 'age_at_baseline','APOE4_alleles','ethnicity','LTFU', 'dementia_date', 'dementia_prevalence', 'dementia_incidence', 'Diagnosis_since_baseline', 'Diagnosis_years_since_baseline', 'Years_Group']
...
output_dir = 'ML_work_v11_XG_Boost_no_feature_selection_only_shap_noage_noapoe4'
...
# Grid search
grid_search_11 = RandomizedSearchCV(estimator=xgb_model, param_distributions=param_grid, cv=inner_cv, n_iter=20, scoring='roc_auc', n_jobs=2, verbose=2)
