...
# ### This notebook contains experiment 1 to 11 of the XGBoost experiments to predict dementia 5 to 10 years from baseline. These include all variables. This code was run via bash.
...
data = pd.read_csv('your_directory_directory')
...
output_dir = 'ML_work_v11_XG_Boost_no_feature_selection_only_shap_5_to_10_years'
...
# ### Experiment 4: with StratifiedKFold and gamma
