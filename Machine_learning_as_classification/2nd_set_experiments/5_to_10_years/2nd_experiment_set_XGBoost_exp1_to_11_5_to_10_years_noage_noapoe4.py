...
# ### This notebook contains experiment 1 to 11 of the XGBoost experiments to predict dementia 5 to 10 years from baseline. This set does not include age and apoe4 alleles. This code was run via bash.
...
data = pd.read_csv('your_directory_path_to_file')
...
# Filter the dataset to include only "5 to 10 years" group and controls
filtered_data = data[data['Years_Group'].isin([0, 3])].copy()
...
output_dir = 'ML_work_v11_XG_Boost_no_feature_selection_only_shap_5_to_10_years_noage_noapoe4'
...
# ### Experiment 4: StratifiedKFold and gamma
