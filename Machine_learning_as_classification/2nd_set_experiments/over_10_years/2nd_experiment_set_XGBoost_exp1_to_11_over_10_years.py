...
# ### This notebook contains experiment 1 to 11 of the XGBoost experiments to predict dementia over 10 years from baseline. These include all variables. This code was run via bash.
...
columnns_to_drop_2 = ['eid', 'APOE4', 'ethnicity','LTFU', 'dementia_date', 'dementia_prevalence', 'dementia_incidence', 'Diagnosis_since_baseline', 'Diagnosis_years_since_baseline']
...
# ### Experiment 1: Simple parameters to start
...
output_dir = 'ML_work_v11_XG_Boost_no_feature_selection_only_shap_over_10_years'
...
# ### Experimetnt 3: Like experiment 2 + additional trees
